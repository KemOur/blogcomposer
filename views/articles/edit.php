                ...
                <div class="d-flex justify-content-between align-items-center w-100">
                    <div class="form-row">
                        ...
                        <div class="col-7">
                            ...
                            <input value="<?=$post->title?>" style="width: 850px" type="text" class="form-control" name="title" id="title">
                            </div>
                            <br>
                            <div class="form-group">
                                <label>L'article :</label>
                                <textarea style="width: 850px" class="form-control" rows="5" name="body" id="body"><?=$post->body ?></textarea>
                            </div>
