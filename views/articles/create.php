        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
                <div class="form-row">
                    ...
                    <div class="col-7">
                        <input style="width: 945px" type="text" class="form-control" name="title" id="title">
                        <br>
                        <div class="form-group">
                            <label>L'article :</label>
                            <textarea style="width: 945px" class="form-control" rows="5" name="body" id="body"></textarea>
                        </div>
